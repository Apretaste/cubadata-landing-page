    ...
    <div class="container-width">
				<span id="idiom">
					<img src="/images/blank.gif" width="1" height="1" class="flag flag-cu" alt="cuba"/><input
                            type="checkbox" class="js-switch" name="name2" checked/>
                    ...
                    <div>
                        <ul id="work">
                            <li>
                                ...
                                <p>Be a media authority. Let us get you an honest state of opinion about the hottest
                                    trends in Cuba.</p>
                            </li>
                            <li>
                                <p>PRIVATE SECTOR</p>
                                <p>Optimize your services and products. Let us find what is in the mind of your audience
                                    in Cuba.</p>
                            </li>
                            <li>
                                <p>CIVIL SOCIETY</p>
                                <p>Understand how your followers are composed, their most pressing issues and biggest
                                    concerns.</p>
                            </li>
                            <li>
                                <p>RESEARCH</p>
                                <p>Writing a book or paper? Let us give you the reliable and statistically significant
                                    data you require.</p>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="container-width">
                ...
                <ul class="statistics">
                    <li class="style2">
                        ...
                        <p>We contact anonymously thousands of subscriptors in the island. That is how we get you
                            unbiased, honest and direct answers to basically any questions you may have.</p>
                    </li>
                    <li class="style3">
                        <img src="/images/whyus-perfection.png" alt="whyus-perfection" width="80" height="80">
                        <p>FOCUSED ON PERFECTION</p>
                        <p>Our subscriptors are spread over the country, and our samples are segmented by age, gender,
                            education, location and more, to ensure maximum accuracy on the results.</p>
                    </li>
                    <li class="style4">
                        <img src="/images/whyus-wheel.png" alt="whyus-wheel" width="80" height="80">
                        <p>ALWAYS BEHIND THE WHEEL</p>
                        <p>We will help you coming up with questions, translations, and our experts will analyze the
                            results based on their knowledge of the Cuban culture and society.</p>
                    </li>
                </ul>
            </div>
        </section>
            ...
            <div class="container-width">
                ...
                <ul class="core">
                    <li>
                        ...
                        <h3>PABLO DIAZ</h3>
                        <p>Co-founder of CubaData. Journalist. Director of <a target="_blank"
                    ...
                    <li>
                        ...
                        <h3>SALVI PASCUAL</h3>
                        <p>Coder, Entrepreneur, and University Professor. Founder of <a target="_blank"
            ...
            <footer class="major">
                <ul class="actions special">
                    <li><a href="/files/cubaData.apk" class="button primary"><span><img src="/images/android.png"
                                                                                        width="30" height="30"></span>Download</a>
                    </li>
                </ul>
            </footer>
        </section>
